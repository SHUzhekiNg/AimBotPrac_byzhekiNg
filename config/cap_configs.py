...
class CapConfig():
    def __init__(self):
        ...
        self._C.CAMERA.GAIN = 10.0
        self._C.CAMERA.EXPOSURETIME = 3000.0
        self._C.CAMERA.BLACKLEVEL = 0
        self._C.CAMERA.HEIGHT = 480
        self._C.CAMERA.WIDTH = 640
...
if __name__ == "__main__":
    cap_cfg = CapConfig()
    cfg = cap_cfg.merge_from_file("BaseConfig.yaml")
    #print(cfg)
    print(cfg.CAMERA)
